...
public class GXDLMSActivityCalendar extends GXDLMSObject implements IGXDLMSBase {
	...
	public final void setSeasonProfileActive(final GXDLMSSeasonProfile[] value) {
	...
	public final void setWeekProfileTableActive(final GXDLMSWeekProfile[] value) {
	...
	public final void setSeasonProfilePassive(final GXDLMSSeasonProfile[] value) {
	...
	public final void setWeekProfileTablePassive(final GXDLMSWeekProfile[] value) {
	...
	public final void setDayProfileTablePassive(final GXDLMSDayProfile[] value) {
	...
	public final Object[] getValues() {
		return new Object[] { getLogicalName(), getCalendarNameActive(), getSeasonProfileActive(),
				getWeekProfileTableActive(), getDayProfileTableActive(), getCalendarNamePassive(),
				getSeasonProfilePassive(), getWeekProfileTablePassive(), getDayProfileTablePassive(), getTime() };
	}
	...
	public final int[] getAttributeIndexToRead(final boolean all) {
		final java.util.ArrayList<Integer> attributes = new java.util.ArrayList<Integer>();
	...
	static Object getSeasonProfile(final GXDLMSSettings settings, final GXDLMSSeasonProfile[] target) {
	...
	static Object getWeekProfileTable(final GXDLMSSettings settings, final GXDLMSWeekProfile[] target) {
		GXByteBuffer data = new GXByteBuffer();
		data.setUInt8(DataType.ARRAY.getValue());
		if (target == null) {
			// Add count
	...
	static Object getDayProfileTable(final GXDLMSSettings settings, final GXDLMSDayProfile[] target) {
		GXByteBuffer data = new GXByteBuffer();
		data.setUInt8(DataType.ARRAY.getValue());
		if (target == null) {
			// Add count
			...
			for (final GXDLMSDayProfile it : target) {
				...
				for (final GXDLMSDayProfileAction action : it.getDaySchedules()) {
					data.setUInt8(DataType.STRUCTURE.getValue());
					data.setUInt8(3);
					...
					GXCommon.setData(settings, data, DataType.OCTET_STRING,
							GXCommon.logicalNameToBytes(action.getScriptLogicalName()));
	...
	static GXDLMSSeasonProfile[] getSeasonProfile(final ValueEventArgs e, final Object value) {
		final List<GXDLMSSeasonProfile> items = new ArrayList<GXDLMSSeasonProfile>();
		if (value != null) {
			boolean useUtc;
			...
			for (final Object item : (List<?>) value) {
				...
				it.setStart((GXDateTime) GXDLMSClient.changeType((byte[]) arr.get(1), DataType.DATETIME, useUtc));
	...
	static GXDLMSWeekProfile[] getWeekProfileTable(final Object value) {
		final List<GXDLMSWeekProfile> items = new ArrayList<GXDLMSWeekProfile>();
		if (value != null) {
			for (final Object item : (List<?>) value) {
				List<?> arr = (List<?>) item;
	...
	static GXDLMSDayProfile[] getDayProfileTable(final ValueEventArgs e, final Object value) {
		...
		if (value != null) {
			...
			for (final Object item : (List<?>) value) {
				...
				final List<GXDLMSDayProfileAction> actions = new ArrayList<GXDLMSDayProfileAction>();
				for (final Object it2 : (List<?>) arr.get(1)) {
					List<?> arr1 = (List<?>) it2;
					final GXDLMSDayProfileAction ac = new GXDLMSDayProfileAction();
					ac.setStartTime((GXTime) GXDLMSClient.changeType((byte[]) arr1.get(0), DataType.TIME, useUtc));
	...
	public final void setValue(final GXDLMSSettings settings, final ValueEventArgs e) {
		...
		case 10:
			if (e.getValue() instanceof GXDateTime) {
				...
				setTime((GXDateTime) GXDLMSClient.changeType((byte[]) e.getValue(), DataType.DATETIME, useUtc));
			}
			break;
		default:
			e.setError(ErrorCode.READ_WRITE_DENIED);
	...
	private static GXDLMSSeasonProfile[] loadSeasonProfile(final GXXmlReader reader, final String name)
	...
	private static GXDLMSWeekProfile[] loadWeekProfileTable(final GXXmlReader reader, final String name)
			throws XMLStreamException {
	...
	private static GXDLMSDayProfile[] loadDayProfileTable(final GXXmlReader reader, final String name)
			throws XMLStreamException {
	...
	private void saveSeasonProfile(final GXXmlWriter writer, final GXDLMSSeasonProfile[] list, final String name)
			throws XMLStreamException {
		if (list != null) {
	...
	private void saveWeekProfileTable(final GXXmlWriter writer, final GXDLMSWeekProfile[] list, final String name)
			throws XMLStreamException {
		if (list != null) {
			writer.writeStartElement(name);
	...
	private void saveDayProfileTable(final GXXmlWriter writer, final GXDLMSDayProfile[] list, final String name)
			throws XMLStreamException {
		if (list != null) {
			writer.writeStartElement(name);
	...
	public String[] getNames() {
		return new String[] { "Logical Name", "Active Calendar Name ", "Active Season Profile",
				...
				"Passive Season Profile", "Passive Week Profile Table", "Passive Day Profile Table", "Time" };
	}
