...
public class GXDLMSSFSKMacCounters extends GXDLMSObject implements IGXDLMSBase {
    ...
    public GXDLMSSFSKMacCounters(final String ln, final int sn) {
        ...
        synchronizationRegister =
                new java.util.ArrayList<java.util.Map.Entry<Integer, Long>>();
     ...
     */
    public final java.util.ArrayList<java.util.Map.Entry<Integer, Long>>
            getSynchronizationRegister() {
     ...
     *            List of synchronization registers.
     */
    public final void setSynchronizationRegister(
            final java.util.ArrayList<java.util.Map.Entry<Integer, Long>> value) {
     ...
     *            List of broadcast frames counter.
     */
    public final void setBroadcastFramesCounter(
            java.util.ArrayList<java.util.Map.Entry<Integer, Long>> value) {
    ...
    public final Object[] getValues() {
        return new Object[] { getLogicalName(), synchronizationRegister,
                new Object[] { physicalLayerDesynchronization,
                        timeOutNotAddressedDesynchronization,
                        timeOutFrameNotOkDesynchronization,
                        writeRequestDesynchronization,
                        wrongInitiatorDesynchronization },
                broadcastFramesCounter, repetitionsCounter,
                transmissionsCounter, crcOkFramesCounter, crcNOkFramesCounter };
    }
    ...
    public final Object getValue(final GXDLMSSettings settings,
        ...
        case 3: {
            ...
            bb.setUInt8(5);
            GXCommon.setData(settings, bb, DataType.UINT32,
                    physicalLayerDesynchronization);
            GXCommon.setData(settings, bb, DataType.UINT32,
                    timeOutNotAddressedDesynchronization);
            GXCommon.setData(settings, bb, DataType.UINT32,
                    timeOutFrameNotOkDesynchronization);
    ...
    public final void setValue(final GXDLMSSettings settings,
        ...
        case 2: {
            ...
            if (e.getValue() != null) {
                for (Object tmp : (List<?>) e.getValue()) {
                    List<?> it = (List<?>) tmp;
                    synchronizationRegister
                            .add(new GXSimpleEntry<Integer, Long>(
                                    ((Number) it.get(0)).intValue(),
        ...
        case 4: {
            ...
            if (e.getValue() != null) {
                for (Object tmp : (List<?>) e.getValue()) {
                    List<?> it = (List<?>) tmp;
                    broadcastFramesCounter.add(new GXSimpleEntry<Integer, Long>(
                            ((Number) it.get(0)).intValue(),
                            ((Number) it.get(1)).longValue()));
                }
            }
    ...
    public final void load(final GXXmlReader reader) throws XMLStreamException {
        ...
        if (reader.isStartElement("SynchronizationRegisters", true)) {
            while (reader.isStartElement("Item", true)) {
                ...
                synchronizationRegister
                        .add(new GXSimpleEntry<Integer, Long>(k, v));
            }
            reader.readEndElement("SynchronizationRegisters");
        }
        physicalLayerDesynchronization = reader
                .readElementContentAsInt("PhysicalLayerDesynchronization");
        timeOutNotAddressedDesynchronization = reader.readElementContentAsInt(
                "TimeOutNotAddressedDesynchronization");
        timeOutFrameNotOkDesynchronization = reader
                .readElementContentAsInt("TimeOutFrameNotOkDesynchronization");
        writeRequestDesynchronization =
                reader.readElementContentAsInt("WriteRequestDesynchronization");
        wrongInitiatorDesynchronization = reader
                .readElementContentAsInt("WrongInitiatorDesynchronization");
        broadcastFramesCounter.clear();
        ...
        repetitionsCounter =
                reader.readElementContentAsInt("RepetitionsCounter");
        transmissionsCounter =
                reader.readElementContentAsInt("TransmissionsCounter");
        crcOkFramesCounter =
                reader.readElementContentAsInt("CrcOkFramesCounter");
        crcNOkFramesCounter =
                reader.readElementContentAsInt("CrcNOkFramesCounter");
    }
    ...
    public final void save(final GXXmlWriter writer) throws XMLStreamException {
        ...
        writer.writeElementString("PhysicalLayerDesynchronization",
                physicalLayerDesynchronization);
        writer.writeElementString("TimeOutNotAddressedDesynchronization",
                timeOutNotAddressedDesynchronization);
        writer.writeElementString("TimeOutFrameNotOkDesynchronization",
                timeOutFrameNotOkDesynchronization);
        writer.writeElementString("WriteRequestDesynchronization",
                writeRequestDesynchronization);
        writer.writeElementString("WrongInitiatorDesynchronization",
                wrongInitiatorDesynchronization);
        if (broadcastFramesCounter != null) {
