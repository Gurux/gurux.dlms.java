...
public class GXDLMSSapAssignment extends GXDLMSObject implements IGXDLMSBase {
     ...
     * @param name
     *            Logical device name.
     * @return Generated bytes sent to the meter.
     ...
     *             Signature exception.
     */
    public final byte[][] addSap(GXDLMSClient client, short id, String name)
     ...
     *             Signature exception.
     */
    public final byte[][] removeSap(GXDLMSClient client, String name) throws InvalidKeyException,
            ...
            if (e.getValue() != null) {
                ...
                for (Object item : (List<?>) e.getValue()) {
                    ...
                    if (tmp instanceof byte[]) {
                        str = GXDLMSClient.changeType((byte[]) tmp, DataType.STRING, useUtc)
                                .toString();
                    } else {
                        str = tmp.toString();
                    }
                    sapAssignmentList.add(new GXSimpleEntry<Integer, String>(
                            ((Number) ((List<?>) item).get(0)).intValue(), str));
                }
            }
        } else {
            e.setError(ErrorCode.READ_WRITE_DENIED);
