 ...
 */
public class GXDLMSSFSKMacSynchronizationTimeouts extends GXDLMSObject
    ...
    public final Object[] getValues() {
        return new Object[] { getLogicalName(), searchInitiatorTimeout,
                synchronizationConfirmationTimeout, timeOutNotAddressed,
                timeOutFrameNotOK };
    }
    ...
    public final void load(final GXXmlReader reader) throws XMLStreamException {
        searchInitiatorTimeout =
                reader.readElementContentAsInt("SearchInitiatorTimeout");
        synchronizationConfirmationTimeout = reader
                .readElementContentAsInt("SynchronizationConfirmationTimeout");
        timeOutNotAddressed =
                reader.readElementContentAsInt("TimeOutNotAddressed");
        timeOutFrameNotOK = reader.readElementContentAsInt("TimeOutFrameNotOK");
    }

    @Override
    public final void save(final GXXmlWriter writer) throws XMLStreamException {
        writer.writeElementString("SearchInitiatorTimeout",
                searchInitiatorTimeout);
        writer.writeElementString("SynchronizationConfirmationTimeout",
                synchronizationConfirmationTimeout);
