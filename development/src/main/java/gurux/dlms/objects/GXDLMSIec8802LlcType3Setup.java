 ...
 */
public class GXDLMSIec8802LlcType3Setup extends GXDLMSObject
    ...
    public final Object[] getValues() {
        return new Object[] { getLogicalName(), maximumOctetsACnPdu,
                maximumTransmissions, acknowledgementTime, receiveLifetime,
                transmitLifetime };
    }
    ...
    public final void load(final GXXmlReader reader) throws XMLStreamException {
        maximumOctetsACnPdu =
                reader.readElementContentAsInt("MaximumOctetsACnPdu");
        maximumTransmissions =
                (byte) reader.readElementContentAsInt("MaximumTransmissions");
        acknowledgementTime =
                reader.readElementContentAsInt("AcknowledgementTime");
