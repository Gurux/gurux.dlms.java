 ...
 */
public class GXDLMSSFSKReportingSystemList extends GXDLMSObject
    ...
    /**
     * @param value
     *            Contains the system titles of the server systems which have
     *            made a DiscoverReport request and which have not already been
     *            registered.
     */
    public final void
            setReportingSystemList(final java.util.ArrayList<byte[]> value) {
    ...
    public final void load(final GXXmlReader reader) throws XMLStreamException {
        ...
        if (reader.isStartElement("ReportingSystems", true)) {
            while (reader.isStartElement("Item", false)) {
                reportingSystemList.add(GXCommon
                        .hexToBytes(reader.readElementContentAsString("Item")));
            }
        }
    }
