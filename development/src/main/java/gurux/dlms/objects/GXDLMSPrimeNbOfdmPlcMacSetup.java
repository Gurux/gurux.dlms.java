 ...
 */
public class GXDLMSPrimeNbOfdmPlcMacSetup extends GXDLMSObject
    ...
    public final Object[] getValues() {
        return new Object[] { getLogicalName(), macMinSwitchSearchTime,
    ...
    public final void load(final GXXmlReader reader) throws XMLStreamException {
        macMinSwitchSearchTime = (short) reader
                .readElementContentAsInt("MacMinSwitchSearchTime");
        macMaxPromotionPdu =
                (short) reader.readElementContentAsInt("MacMaxPromotionPdu");
        macPromotionPduTxPeriod = (short) reader
                .readElementContentAsInt("MacPromotionPduTxPeriod");
        macBeaconsPerFrame =
                (short) reader.readElementContentAsInt("MacBeaconsPerFrame");
        macScpMaxTxAttempts =
                (short) reader.readElementContentAsInt("MacScpMaxTxAttempts");
        macCtlReTxTimer =
                (short) reader.readElementContentAsInt("MacCtlReTxTimer");
        macMaxCtlReTx = (short) reader.readElementContentAsInt("MacMaxCtlReTx");
    }

    @Override
    public final void save(final GXXmlWriter writer) throws XMLStreamException {
        writer.writeElementString("MacMinSwitchSearchTime",
                macMinSwitchSearchTime);
        writer.writeElementString("MacMaxPromotionPdu", macMaxPromotionPdu);
        writer.writeElementString("MacPromotionPduTxPeriod",
                macPromotionPduTxPeriod);
