...
public class GXDLMSTranslator {
	...
	/**
	 * Is only PDU shown when data is parsed with messageToXml. {@link messageToXml}
	 * {@link CompleatePdu}
	 */
	 ...
	 * Constructor.
	 * 
	 * @param type Translator output type.
	 */
	...
	/**
	 * @param value Is only PDU shown when data is parsed with messageToXml.
	 */
	 ...
	 * 
	 * @param bytes    Byte array.
	 * @param addSpace Is space added between the bytes.
	 * @return Hex string.
	 */
	...
	/**
	 * Is only complete PDU parsed and shown. {@link messageToXml} {@link PduOnly}
	 */
	...
	/**
	 * @param value Is string serialized as hex.
	 */
	...
	/**
	 * Find next frame from the string. Position of data is set to the begin of new
	 * frame. If PDU is null it is not updated.
	 * 
	 * @param data Data where frame is search.
	 * @param pdu  PDU of received frame is set here.
	 ...
	 * @param list       List of tags by ID.
	 * @param tagsByName List of tags by name.
	 */
	...
	public final byte[] getPdu(final byte[] value) throws InvalidKeyException, NoSuchAlgorithmException,
	...
	public final byte[] getPdu(final GXByteBuffer value) throws InvalidKeyException, NoSuchAlgorithmException,
			NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
	 ...
	 * @throws IllegalBlockSizeException          Illegal block size exception.
	 */
	public final String messageToXml(final byte[] value) throws InvalidKeyException, NoSuchAlgorithmException,
			NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
	...
	public final String messageToXml(final GXByteBuffer value) throws InvalidKeyException, NoSuchAlgorithmException,
			NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
	...
	public final void messageToXml(final GXDLMSTranslatorMessage msg)
		...
		try {
			...
			// If Wireless M-Bus.
				...
				if (!getPduOnly()) {
					xml.appendLine("<WirelessMBus len=\"" + xml.integerToHex((long) data.getPacketLength() - offset, 0)
							+ "\" >");
					xml.appendLine(
							"<TargetAddress Value=\"" + xml.integerToHex(settings.getServerAddress(), 0) + "\" />");
					xml.appendLine(
	 ...
	 * 
	 * @param pdu Converted hex string.
	...
	/**
	 * @param value Are comments added.
	 */
	 ...
	 * 
	 * @param value         Bytes to convert.
	 * @param omitNameSpace Omit name space.
	 * @param arg           Translator arguments.
	 * @return Converted XML.
	 */
	 ...
	 * @throws IllegalBlockSizeException          Illegal block size exception.
	 */
	public final String xmlToHexPdu(final String xml) throws InvalidKeyException, NoSuchAlgorithmException,
			NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
	 ...
	 * 
	 * @param xml      Converted XML.
	 * @param addSpace Add spaces between bytes.
	 * @return Converted PDU in hex string.
	 * @throws NoSuchPaddingException             No such padding exception.
	 * @throws NoSuchAlgorithmException           No such algorithm exception.
	 * @throws InvalidAlgorithmParameterException Invalid algorithm parameter
	 ...
	 * @throws IllegalBlockSizeException          Illegal block size exception.
	 */
	public final byte[] xmlToPdu(final String xml) throws InvalidKeyException, NoSuchAlgorithmException,
			NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
	...
	/**
	 * @param value Are numeric values shows as hex.
	 */
	...
	/**
	 * @param value Is XML declaration skipped.
	 */
	...
	/**
	 * @param value Is XML name space skipped.
	 */
	...
	/**
	 * @param value Is General Protection used.
	 */
