...
public enum OpticalProtocolMode
{
    ...
    */
    ...
    private static java.util.HashMap<Integer, OpticalProtocolMode> getMappings()
    {
        if (mappings == null)
        {
            synchronized (OpticalProtocolMode.class)
            {
                if (mappings == null)
                {
                    mappings = new java.util.HashMap<Integer, OpticalProtocolMode>();
                }
            }
        }
        return mappings;
    ...
    private OpticalProtocolMode(int value)
    {
        intValue = value;
