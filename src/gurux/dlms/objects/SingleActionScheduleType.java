...
public enum SingleActionScheduleType
{
    ...
    */
    ...
    private static java.util.HashMap<Integer, SingleActionScheduleType> mappings;
    
    private static java.util.HashMap<Integer, SingleActionScheduleType> getMappings()
    {
        synchronized (SingleActionScheduleType.class)
        {
            if (mappings == null)
            {
                mappings = new java.util.HashMap<Integer, SingleActionScheduleType>();
            }
        }
        return mappings;
    }

    private SingleActionScheduleType(int value)
    {
        intValue = value;
